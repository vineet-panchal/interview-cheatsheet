...
## Note 5 - Supervised Learning: Ensemble Techniques

### Sampling

- selecting a subset of data from the original dataset

#### Single Random Sampling
- equal probability of selecting any data in the dataset
...
- they can be picked up more than once
